        ...
        <div className=' bg-gray-50 px-8 py-6 space-y-6'>
            <div className='flex justify-between items-center'>
                ...
                <div className='flex gap-3 items-center font-semibold text-gray-900'>
                    <button className="flex justify-between items-center gap-2 w-42 rounded-lg bg-secondary px-4 py-2.5 text-sm font-semibold text-white shadow-sm transition-all duration-200 hover:bg-secondary/90 active:scale-[0.98] focus:outline-none focus:ring-2 focus:ring-secondary/30" type='submit'><FaArrowLeft className='text-lg' />Back to Products</button>
                </div>
            </div>
            ...
            <div className="rounded-xl border border-gray-200 bg-white p-8">
                <form onSubmit={handleForm} className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    ...
                    <div>
                        <label className="mb-2 block text-sm font-medium text-gray-700">Unit File <span className="text-red-500">*</span></label>
                        <input
                            type="file"
                            name="unitFile"
                            onChange={handleChange}
